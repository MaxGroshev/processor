...
int main()
{
    ...
    size_t count_of_com; //count of commands that assembler will translate
...
char** read_word_com (size_t* count_of_com, FILE* word_com)
{
    size_t count_of_strings = 50;    //count of strings to which memory will be allocated //fault is here
